...
namespace DialogueEditor
{
    public class ConversationManager2 : MonoBehaviour
    {
        ...
        public static ConversationManager2 Instance2 { get; private set; }
        ...
        // Prefabs
        public UIConversationButton2 ButtonPrefab;
        // Default values
        ...
        // Selection options
        private List<UIConversationButton2> m_uiOptions;
        ...
        private void Awake()
        {
            ...
            m_uiOptions = new List<UIConversationButton2>();
        ...
        public void PressSelectedOption()
        {
            ...
            UIConversationButton2 button = m_uiOptions[m_currentSelectedIndex];
            button.OnClick();
        }

        public void AlertHover(UIConversationButton2 button)
        {
        ...
        private void CreateUIOptions()
        {
            ...
            if (m_currentSpeech.ConnectionType == Connection.eConnectionType.Option)
            {
                for (int i = 0; i < m_currentSpeech.Connections.Count; i++)
                {
                    ...
                    {
                        UIConversationButton2 uiOption = CreateButton();
                        uiOption.SetupButton(UIConversationButton2.eButtonType.Option, connection.OptionNode);
                    }
                }
            }
            ...
            else
            {
                ...
                if (notAutoAdvance || allowVisibleOptionWithAuto)
                {
                    if (m_currentSpeech.ConnectionType == Connection.eConnectionType.Speech)
                    {
                        ...
                        if (next == null)
                        {
                            uiOption.SetupButton(UIConversationButton2.eButtonType.None, null);
                        }
                        // Else, valid speech node found
                        else
                        {
                            uiOption.SetupButton(UIConversationButton2.eButtonType.Speech, next);
                        }
        ...
        private UIConversationButton2 CreateButton()
        {
            UIConversationButton2 button = GameObject.Instantiate(ButtonPrefab, OptionsPanel);
